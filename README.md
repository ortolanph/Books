...
* [encryption - How to encrypt and decrypt String with my passphrase in Java (Pc not mobile platform)? - Stack Overflow](https://stackoverflow.com/questions/23561104/how-to-encrypt-and-decrypt-string-with-my-passphrase-in-java-pc-not-mobile-plat?lq=1)
